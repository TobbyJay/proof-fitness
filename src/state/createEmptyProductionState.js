...
import { createRunProgressionState } from '../domain/running/runProgram.js';
...
export function createEmptyProductionState() {
  return {
    ...
    transitions:[], reviews:[], activeWorkout:null, workouts:[], runs:[], runningProgression:createRunProgressionState(), mealChecks:[], checkIns:[], measurements:[], progression:[],
